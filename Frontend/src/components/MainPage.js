                    ...
                    <section className='m-5 p-3 justify-content-center text-center'>
                        <div className='question-section text-center' style={{
                            ...
                            <div className='answer-section text-center'>
                                ...
                                <button className='answerBtn mx-3 my-2 btn btn-primary' onClick={() => handleAnswer("Yes")}>Yes</button>
                                <button className='answerBtn mx-3 my-2 btn btn-primary' onClick={() => handleAnswer("No")}>No</button>
                            </div>
                            <div className='text-center'>
                                <button className='btn btn-primary m-2' onClick={handlePrevious}>Previous</button>
                                <button className='btn btn-primary m-2' disabled={!ans} onClick={handleNext}>
